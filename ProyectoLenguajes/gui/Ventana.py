...
cargarGramaticaButton= Button(ve, text="Cargar", fg='white', background='tomato', font='Fixedsys 16' ,command=cargarGramatica)
...
generarAutomataLr0Button= Button(ve, text="Automata LR0", fg='white', background='gray51', font='Fixedsys 16',command= generarAutomataLr0)
...
generarAutomataLr1Button= Button(ve, text="Automata LR1", fg='white', background='sea green', font='Fixedsys 16',command= generarAutomataLr1)
...
generarTablaLr0Button= Button(ve, text="Tabla LR0", fg='white', background='navy', font='Fixedsys 16',command= generarTablaLr0)
